  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((prefs) {
      ListaMensaBloc().getMessageBack(context, true).then((map) {
        setState(() {
          listaFinal.clear();
          if (map != null && map.response.dsMensagens.dsMensagens2.ttMensagens != null) {
            //listaGlobal = map1;
            ...
            listaFinal = map.response.dsMensagens.dsMensagens2.ttMensagens.where((element) => element.ttMensVisu == null).toList();
        ...
        child: listaFinal.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  TtMensagens objMensaMob = listaFinal[index];
                    ...
                    MultiSelectItem(
                      ...
                      child: Column(
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                                _visualizarMensaWeb(listaFinal[index], index);
                           },
                                    ...
                                    child: AbsorbPointer(
                                      child: Row(
                                        children: [
                                          Expanded(
                                            flex: 1,
                                            child: listaFinal[index].ttMensVisu == null
                                                ? Icon(
                                                    Icons.messenger,
                                                    color: Colors.green,
                                          ...
                                          Expanded(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                  fontWeight:
                                                      listaFinal[index].ttMensVisu == null
                                                          ? FontWeight.bold
                                                          : FontWeight.normal,
                                                  color:
                                                      listaFinal[index].ttMensVisu == null
                                            ...
                                            child: Text(
                                              ...
                                              style: TextStyle(
                                                ...
                                                listaFinal[index].ttMensVisu == null
                                                    ? FontWeight.bold
                                                    : FontWeight.normal,
                                                color: listaFinal[index].ttMensVisu == null
                                                    ? null
                                                    : Colors.grey,
                                                fontSize: 12,
                                              ),
                                          ...
                                          listaFinal[index] == null
                                              ...
                                              : Expanded(
                                            flex: 1,
                                            child: listaFinal[index].requerCiencia == true && listaFinal[index].ttMensVisu == null //pendente == isFalse
                                                ? Icon(Icons.drive_file_rename_outline,
                                              color: Colors.orange[200],
                                              size: 30,
                                            )
                                                : listaFinal[index].requerCiencia == true && listaFinal[index].ttMensVisu != null ? Icon(Icons.check_circle_sharp,
                                              color: Colors.green,
                                              size: 30,
                                            ): Icon(null) ,
                                          ),
...
////////////////////////////////////////////////////////////////////////////////
  ///[MOBILE]
  void acaoClick(TtMensagens obj) {
    //
    abrirMensa(obj);
    //
    // setState(() {
