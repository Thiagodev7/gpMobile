...
class TtRetorno2 {
  ...
  TtRetorno2.fromJson(Map<String, dynamic> json) {
    ...
    mensagemLida = json['mensagemLida'];
    mensagemAssinada = json['mensagemAssinada'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['mensagemLida'] = this.mensagemLida;
    data['mensagemAssinada'] = this.mensagemAssinada;
